...
public class Films {
    ...
    public Films(int _id, String _title, String _original, String _title_romanised, String _description, String _director, String _year, String _time, String _score) {
        this.id = _id;
        this.title = _title;
